package org.osmf.elements.audioClasses
{
   ...
   public class SoundAdapter extends EventDispatcher
   {
      ...
      {
         return this.channel != null?Number(this.channel.position / 1000):Number(this.lastStartTime / 1000);
      }
      ...
      public function play(param1:Number = -1) : Boolean
      {
         ...
         if(this.channel == null)
         {
            try
            {
               this.channel = this.sound.play(time != -1?Number(time):Number(this.lastStartTime));
            }
