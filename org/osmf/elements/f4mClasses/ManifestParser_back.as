package org.osmf.elements.f4mClasses
{
   ...
   public class ManifestParser_back
   {
      
      namespace xmlns = "http://ns.adobe.com/f4m/1.0";
       
      
      public function ManifestParser_back()
      {
         super();
      }
      ...
      public function parse(param1:String, param2:String = null) : Manifest
      {
		  ...
		  ExternalInterface.call("msg","[ManifestParser.parse]");
         var _loc6_:XML = null;
         var _loc7_:Boolean = false;
         var _loc8_:XML = null;
         var _loc9_:XML = null;
         var _loc10_:XML = null;
         var _loc11_:Media = null;
         var _loc3_:Manifest = new Manifest();
		 ExternalInterface.call("msg","[ManifestParser.parse].[param1]"+param1.replace("<?xml version=\"1.0\" encoding=\"UTF-8\"?>",""));
         var _loc4_:XML = new XML(param1);
		 var nmsp:Namespace = _loc4_.namespace();
		 ExternalInterface.call("msg","[ManifestParser.parse].[_loc4_manifest .id=]"+_loc4_.nmsp::id.text());
         if(_loc4_.nmsp::id.length() > 0)
         {
            _loc3_.id = _loc4_.nmsp::id.text();
         }
         if(_loc4_.nmsp::classid.length() > 0)
         {
            _loc3_.classid = _loc4_.nmsp::classid.text();
         }
         if(_loc4_.nmsp::duration.length() > 0)
         {
            _loc3_.duration = _loc4_.nmsp::duration.text();
         }
         if(_loc4_.nmsp::startTime.length() > 0)
         {
            _loc3_.startTime = DateUtil.parseW3CDTF(_loc4_.nmsp::startTime.text());
         }
         if(_loc4_.nmsp::mimeType.length() > 0)
         {
            _loc3_.mimeType = _loc4_.nmsp::mimeType.text();
         }
         if(_loc4_.nmsp::streamType.length() > 0)
         {
            _loc3_.streamType = _loc4_.nmsp::streamType.text();
         }
         if(_loc4_.nmsp::deliveryType.length() > 0)
         {
            _loc3_.deliveryType = _loc4_.nmsp::deliveryType.text();
         }
         if(_loc4_.nmsp::baseURL.length() > 0)
         {
            _loc3_.baseURL = _loc4_.nmsp::baseURL.text();
         }
         var _loc5_:String = _loc3_.baseURL != null?_loc3_.baseURL:param2;
         for each(_loc6_ in _loc4_.nmsp::dvrInfo)
         {
            this.parseDVRInfo(_loc6_,_loc5_,_loc3_);
         }
         _loc7_ = false;
         for each(_loc8_ in _loc4_.nmsp::media)
         {
         ...
         for each(_loc9_ in _loc4_.nmsp::drmAdditionalHeader)
         {
            this.parseDRMAdditionalHeader(_loc9_,_loc3_.media,_loc5_,_loc3_);
         }
         for each(_loc10_ in _loc4_.nmsp::bootstrapInfo)
         {
            this.parseBootstrapInfo(_loc10_,_loc3_.media,_loc5_,_loc3_);
         }
		 ExternalInterface.call("msg","[ManifestParser.parse].[generateRTMPBaseURL_begin]");
         this.generateRTMPBaseURL(_loc3_);
		 ExternalInterface.call("msg","[ManifestParser.parse].[_loc3_]"+_loc3_.id);
         return _loc3_;
      }
      ...
      private function parseMedia(param1:XML, param2:String) : Media
      {
         ...
         if(value.attribute("url").length() > 0)
         {
            ...
            if(value.metadata.length() > 0)
            {
               ...
               try
               {
                  header = data.readObject() as String;
                  metaInfo = data.readObject();
      ...
      {
         var _loc6_:Media = null;
         var _loc8_:String = null;
         var _loc9_:Base64Decoder = null;
         var _loc5_:String = null;
         ...
         {
            _loc8_ = param1.text();
            _loc9_ = new Base64Decoder();
            _loc9_.decode(_loc8_);
      ...
      public function createResource(param1:Manifest, param2:URLResource) : MediaResourceBase
      {
         ...
         var _loc16_:DynamicStreamingResource = null;
         var _loc17_:Vector.<DynamicStreamingItem> = null;
         var _loc18_:String = null;
         var _loc19_:DynamicStreamingItem = null;
         var _loc3_:Metadata = null;
         var _loc4_:Metadata = null;
         var _loc10_:URL = new URL(param2.url);
         var _loc11_:String = "/" + _loc10_.path;
         _loc11_ = _loc11_.substr(0,_loc11_.lastIndexOf("/"));
         var _loc12_:String = _loc10_.protocol + "://" + _loc10_.host + (_loc10_.port != ""?":" + _loc10_.port:"") + _loc11_;
         if(param1.media.length == 1)
         {
            _loc6_ = param1.media[0] as Media;
            _loc8_ = _loc6_.url;
            _loc14_ = null;
            ...
            if(_loc6_.bootstrapInfo != null)
            {
               ...
               _loc4_ = new Metadata();
               _loc4_.addValue(MetadataNamespaces.HTTP_STREAMING_BOOTSTRAP_KEY,_loc6_.bootstrapInfo);
               if(_loc7_.length > 0)
               {
         ...
         var _loc13_:StreamingURLResource = param2 as StreamingURLResource;
         if(_loc13_ != null)
         {
      ...
      {
         return param1.streamType == StreamType.LIVE && param1.dvrInfo != null?StreamType.DVR:param1.streamType;
      }
   }
}
