package org.osmf.elements
{
   ...
   public class LightweightVideoElement extends LoadableElementBase
   {
      ...
      {
         return !!this.defaultTimeTrait?Number(this.defaultTimeTrait.duration):Number(NaN);
      }
      ...
      {
         return this.stream != null?Number(this.stream.currentFPS):Number(0);
      }
      ...
      override protected function processReadyState() : void
      {
         ...
         if(_loc2_ != null && _loc2_.drmContentData)
         {
      ...
      private function onNetStatusEvent(param1:NetStatusEvent) : void
      {
         ...
         switch(param1.info.code)
         {
            ...
            case NetStreamCodes.NETSTREAM_PLAY_STREAMNOTFOUND:
               _loc2_ = new MediaError(MediaErrorCodes.NETSTREAM_STREAM_NOT_FOUND,"连接不上视频流，可能是您的网速过慢，请刷新网页重新试一下!");
               break;
            case NetStreamCodes.NETSTREAM_PLAY_FILESTRUCTUREINVALID:
               _loc2_ = new MediaError(MediaErrorCodes.NETSTREAM_FILE_STRUCTURE_INVALID,"您的网速过慢，请刷新网页重新试一下!");
               break;
