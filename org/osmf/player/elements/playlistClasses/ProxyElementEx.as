package org.osmf.player.elements.playlistClasses
{
   ...
   public class ProxyElementEx extends MediaElement
   {
      ...
      public function ProxyElementEx(param1:MediaElement = null)
      {
         super();
      ...
      public function set proxiedElement(param1:MediaElement) : void
      {
         ...
         if(param1 != this._proxiedElement)
         {
            if(this._proxiedElement != null)
            {
               ...
               {
                  if(super.hasTrait(_loc2_) == false && this.blocksTrait(_loc2_) == false)
                  {
      ...
      {
         return this._blockedTraits && this._blockedTraits.indexOf(param1) != -1;
      }
   }
}
