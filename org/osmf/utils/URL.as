package org.osmf.utils
{
   public class URL
   {
      ...
      public function set fragment(param1:String) : void
      {
         if(param1 != null)
         {
            this._fragment = param1.replace(/^_/,"");
         }
      }
      ...
      public function getParamValue(param1:String) : String
      {
         ...
         var _loc2_:RegExp = new RegExp("[/?&]*" + param1 + "=([^&_]*)","i");
         var _loc3_:Array = this._query.match(_loc2_);
         var _loc4_:String = _loc3_ == null?"":_loc3_[1];
         return _loc4_;
      }
      ...
      private function parseUrl() : void
      {
         ...
         else
         {
            ...
            _loc4_ = /^([a-z+\w\+\.\-]+:\/\/)?([^\/?_]*)?(\/[^?_]*)?(\?[^_]*)?(\_.*)?/i;
            _loc5_ = _loc3_.match(_loc4_);
            if(_loc5_ != null)
            {
