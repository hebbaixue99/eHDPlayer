   ...
   public class FMSURL extends URL
   {
      ...
      private function parsePath() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               this._streamName = this._streamName + _loc2_[_loc5_];
               _loc5_++;
            }
      ...
      private function parseQuery() : void
      {
         ...
         {
            _loc12_ = _loc1_[_loc2_].toString().search(/:\//);
            if(_loc12_ == -1)
            {
         ...
         {
            _loc13_ = _loc1_[_loc11_].toString().search(/:\//);
            _loc9_ = _loc13_ + 2;
            if(_loc1_[_loc11_].charAt(_loc9_) == "/")
            {
               _loc9_++;
            }
            _loc7_ = _loc1_[_loc11_].indexOf(":",_loc9_);
            _loc8_ = _loc1_[_loc11_].indexOf("/",_loc9_);
            ...
            {
               _loc10_ = _loc1_[_loc11_].indexOf("/");
               _loc5_ = "localhost";
            }
            if(_loc11_ == _loc4_)
            {
