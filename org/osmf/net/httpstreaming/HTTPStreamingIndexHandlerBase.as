package org.osmf.net.httpstreaming
{
   ...
   public class HTTPStreamingIndexHandlerBase extends EventDispatcher
   {
      ...
      public function getPrevFile(param1:int) : HTTPStreamRequest
      {
         throw new IllegalOperationError("The getPrevFile() method must be overridden by the derived class.");
      }
      ...
      public function getTotalFragments() : uint
      {
         throw new IllegalOperationError("The dvrGetStreamInfo() method must be overridden by the derived class.");
      }
      
      public function getCurrFragID() : uint
      {
         throw new IllegalOperationError("The dvrGetStreamInfo() method must be overridden by the derived class.");
      }
   }
