package org.osmf.net.httpstreaming.flv
{
   ...
   public class FLVTagVideo extends FLVTag
   {
      ...
      public function set frameType(param1:int) : void
      {
         ...
         bytes[TAG_HEADER_BYTE_COUNT + 0] = bytes[TAG_HEADER_BYTE_COUNT + 0] | (param1 & 15) << 4;
      }
      ...
      public function set codecID(param1:int) : void
      {
         ...
         bytes[TAG_HEADER_BYTE_COUNT + 0] = bytes[TAG_HEADER_BYTE_COUNT + 0] | param1 & 15;
      }
      ...
      public function get avcCompositionTimeOffset() : int
      {
         ...
         var _loc1_:* = bytes[TAG_HEADER_BYTE_COUNT + 2] << 16;
         _loc1_ = _loc1_ | bytes[TAG_HEADER_BYTE_COUNT + 3] << 8;
         _loc1_ = _loc1_ | bytes[TAG_HEADER_BYTE_COUNT + 4];
         if(_loc1_ & 8388608)
         {
            _loc1_ = _loc1_ | 4278190080;
         }
         return _loc1_;
      }
