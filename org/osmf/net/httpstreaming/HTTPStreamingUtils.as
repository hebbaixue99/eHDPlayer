package org.osmf.net.httpstreaming
{
   ...
   public class HTTPStreamingUtils
   {
      ...
      public static function createF4FIndexInfo(param1:URLResource) : HTTPStreamingF4FIndexInfo
      {
         ...
         var _loc6_:Vector.<HTTPStreamingF4FStreamInfo> = null;
         var _loc7_:DVRInfo = null;
         var _loc2_:HTTPStreamingF4FIndexInfo = null;
      ...
      private static function generateStreamInfos(param1:URLResource) : Vector.<HTTPStreamingF4FStreamInfo>
      {
         ...
         var _loc10_:DynamicStreamingItem = null;
         ...
         var _loc6_:BootstrapInfo = null;
         var _loc7_:DynamicStreamingResource = param1 as DynamicStreamingResource;
         if(_loc7_ != null)
         {
