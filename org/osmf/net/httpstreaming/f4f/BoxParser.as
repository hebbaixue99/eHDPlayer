package org.osmf.net.httpstreaming.f4f
{
   ...
   class BoxParser extends EventDispatcher
   {
      ...
      {
         var _loc3_:AdobeBootstrapBox = null;
         var _loc4_:AdobeFragmentRandomAccessBox = null;
         var _loc5_:MediaDataBox = null;
         ...
         while(_loc2_ != null)
         {
            ...
            {
               this._ba.position = this._ba.position + _loc2_.size - (F4FConstants.FIELD_SIZE_LENGTH + F4FConstants.FIELD_TYPE_LENGTH);
            }
      ...
      function readLongUIntToNumber() : Number
      {
         ...
         var _loc1_:Number = this._ba.readUnsignedInt();
         _loc1_ = _loc1_ * 4294967296;
         _loc1_ = _loc1_ + this._ba.readUnsignedInt();
         return _loc1_;
      }
      ...
      {
         var _loc13_:AdobeSegmentRunTable = null;
         var _loc14_:AdobeFragmentRunTable = null;
		 ...
		 ExternalInterface.call("msg","[BoxParser].[param2.timeScale]="+param2.timeScale);
      ...
      {
         var _loc11_:LocalRandomAccessEntry = null;
