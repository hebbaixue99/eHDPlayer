package org.osmf.net.httpstreaming.f4f
{
   ...
   public class HTTPStreamingF4FIndexHandler extends HTTPStreamingIndexHandlerBase
   {
      ...
      {
         var _loc2_:AdobeBootstrapBox = null;
         var _loc4_:BootstrapInfo = null;
         ...
         {
            _loc4_ = this.streamInfos[_loc3_].bootstrapInfo;
            if(_loc4_ == null || _loc4_.url == null && _loc4_.data == null)
            {
               dispatchEvent(new HTTPStreamingIndexHandlerEvent(HTTPStreamingIndexHandlerEvent.NOTIFY_ERROR));
               return;
            }
      ...
      override public function processIndexData(param1:*, param2:Object) : void
      {
         ...
         var _loc4_:AdobeBootstrapBox = this.processBootstrapData(param1,_loc3_);
         if(_loc4_ == null)
         {
            dispatchEvent(new HTTPStreamingIndexHandlerEvent(HTTPStreamingIndexHandlerEvent.NOTIFY_ERROR));
            return;
      ...
      override public function getTotalTime() : uint
      {
         var _loc1_:AdobeBootstrapBox = this.bootstrapBoxes[0];
         return _loc1_.totalDuration / 1000;
      }
      
      override public function getTotalFragments() : uint
      {
         var _loc1_:AdobeBootstrapBox = this.bootstrapBoxes[0];
		 ExternalInterface.call("msg","[F4F].[totalFragments]="+_loc1_.totalFragments);
         return _loc1_.totalFragments;
      }
      
      override public function getFileForTime(param1:Number, param2:int) : HTTPStreamRequest
      {
         var _loc6_:FragmentDurationPair = null;
         var _loc7_:uint = 0;
         var _loc8_:String = null;
         var _loc3_:AdobeBootstrapBox = this.bootstrapBoxes[param2];
         var _loc4_:HTTPStreamRequest = null;
         ...
         {
            this.currentFAI = _loc5_.findFragmentIdByTime(param1 * _loc3_.timeScale,_loc3_.currentMediaTime,!!_loc3_.contentComplete()?false:Boolean(_loc3_.live));
      ...
      override public function getCurrFragID() : uint
      {
         return this.currentFAI.fragId - 1;
      }
      
      override public function getPrevFile(param1:int) : HTTPStreamRequest
      {
         var _loc4_:AdobeFragmentRunTable = null;
         ...
         if(param1 >= 0 && param1 < this.streamInfos.length)
         {
            ...
            this.currentFAI = _loc4_.validateFragment(this.currentFAI.fragId,_loc2_.currentMediaTime,!!_loc2_.contentComplete()?false:Boolean(_loc2_.live));
            ...
            if((this.streamInfos[param1].streamName as String).indexOf("http") != 0)
            {
			   ...
			   ExternalInterface.call("msg","[F4F].[_loc8_2]="+_loc8_);
			}
            else
            {
               _loc8_ = this.streamInfos[param1].streamName + "Seg" + _loc7_ + "-Frag" + this.currentFAI.fragId;
			   ExternalInterface.call("msg","[F4F].[_loc8_3]="+_loc8_);
            }
      ...
      override public function getNextFile(param1:int) : HTTPStreamRequest
      {
         ...
         if(param1 >= 0 && param1 < this.streamInfos.length)
         {
            _loc4_ = this.getFragmentRunTable(_loc2_);
            _loc5_ = this.currentFAI;
            this.currentFAI = _loc4_.validateFragment(this.currentFAI.fragId + 1,_loc2_.currentMediaTime,!!_loc2_.contentComplete()?false:Boolean(_loc2_.live));
            if(this.currentFAI == null || this.fragmentOverflow(_loc2_,this.currentFAI.fragId))
            {
               if(!_loc2_.live || _loc2_.contentComplete())
               {
            ...
            {
               _loc8_ = this.serverBaseURL + "/" + this.streamInfos[param1].streamName + "Seg" + _loc7_ + "-Frag" + this.currentFAI.fragId;
			   ExternalInterface.call("msg","[F4F].[_loc8_99]="+_loc8_);
			}
            else
            {
               _loc8_ = this.streamInfos[param1].streamName + "Seg" + _loc7_ + "-Frag" + this.currentFAI.fragId;
			   ExternalInterface.call("msg","[F4F].[_loc8_98]="+_loc8_);
            }
            _loc3_ = new HTTPStreamRequest(_loc8_);
            this.checkQuality(param1);
            this.notifyFragmentDuration(this.currentFAI.fragDuration / _loc2_.timeScale);
      ...
      function calculateSegmentDuration(param1:AdobeBootstrapBox, param2:Number) : Number
      {
         ...
         while(_loc5_ >= 0)
         {
            ...
            if(_loc6_.firstFragment <= _loc4_)
            {
               _loc7_ = _loc6_.duration;
               _loc8_ = _loc6_.durationAccrued;
               _loc8_ = _loc8_ + (_loc4_ - _loc6_.firstFragment) * _loc6_.duration;
               if(param2 > 0)
               {
                  _loc7_ = _loc7_ - (param2 - _loc8_);
               }
               return _loc7_;
            }
            _loc5_--;
      ...
      private function notifyTotalDuration(param1:Number, param2:int) : void
      {
         ...
         var _loc4_:Object = this.f4fIndexInfo.streamInfos[param2].streamMetadata;
         if(_loc4_ == null)
         {
            _loc4_ = new Object();
         }
      ...
      private function notifyIndexReady(param1:int) : void
      {
         ...
         if(!this.dvrGetStreamInfoCall)
         {
            ...
            {
				ExternalInterface.call("msg","[HTTPStreamingF4F].[this._afra.timeScale]="+_loc2_.timeScale);
               this.pureLiveOffset = _loc2_.currentMediaTime - this.offsetFromCurrent * _loc2_.timeScale > 0?Number(_loc2_.currentMediaTime / _loc2_.timeScale - this.offsetFromCurrent):Number(NaN);
            }
      ...
      private function dispatchDVRStreamInfo(param1:AdobeBootstrapBox) : void
      {
         ...
         if(this.f4fIndexInfo.dvrInfo != null)
         {
            ...
            {
               this.f4fIndexInfo.dvrInfo.startTime = !!_loc2_.tableComplete()?Number(0):Number(DVRUtils.calculateOffset(this.f4fIndexInfo.dvrInfo.beginOffset < 0 || isNaN(this.f4fIndexInfo.dvrInfo.beginOffset)?Number(0):Number(this.f4fIndexInfo.dvrInfo.beginOffset),this.f4fIndexInfo.dvrInfo.endOffset < 0 || isNaN(this.f4fIndexInfo.dvrInfo.endOffset)?Number(0):Number(this.f4fIndexInfo.dvrInfo.endOffset),param1.totalDuration / param1.timeScale));
               this.f4fIndexInfo.dvrInfo.startTime = this.f4fIndexInfo.dvrInfo.startTime + _loc2_.fragmentDurationPairs[0].durationAccrued / param1.timeScale;
      ...
      private function fragmentOverflow(param1:AdobeBootstrapBox, param2:uint) : Boolean
      {
         ...
         var _loc5_:AdobeSegmentRunTable = param1.segmentRunTables[0];
         return _loc5_ == null || _loc5_.totalFragments + _loc4_.firstFragment - 1 < param2;
      }
