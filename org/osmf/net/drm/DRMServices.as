package org.osmf.net.drm
{
   ...
   class DRMServices extends EventDispatcher
   {
      ...
      public function get period() : Number
      {
         if(this.voucher != null)
         {
            return !!this.voucher.playbackTimeWindow?Number(this.voucher.playbackTimeWindow.period):this.voucher.voucherEndDate && this.voucher.voucherStartDate?Number((this.voucher.voucherEndDate.time - this.voucher.voucherStartDate.time) / 1000):Number(0);
         }
         return NaN;
      }
