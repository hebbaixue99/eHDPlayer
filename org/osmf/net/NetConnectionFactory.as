package org.osmf.net
{
   ...
   public class NetConnectionFactory extends NetConnectionFactoryBase
   {
      ...
      override public function create(param1:URLResource) : void
      {
         ...
         var sharedConnection:SharedConnection = this.connectionDictionary[key] as SharedConnection;
         var connectionsUnderway:Vector.<URLResource> = this.pendingDictionary[key] as Vector.<URLResource>;
         ...
         else
         {
            ...
            {
               var _loc5_:NetConnectionFactoryEvent = null;
               var _loc6_:URLResource = null;
               var _loc7_:SharedConnection = null;
               var _loc8_:SharedConnection = null;
               ...
               while(_loc4_ < _loc3_.length)
               {
                  ...
                  {
                     _loc7_ = connectionDictionary[key] as SharedConnection;
                     if(_loc7_ != null)
                     {
                        _loc7_.count++;
                     }
      ...
      private function buildPortProtocolSequence(param1:String) : Vector.<PortProtocol>
      {
         ...
         while(_loc8_ < _loc7_.length)
         {
            ...
            {
               _loc10_ = new PortProtocol();
               _loc10_.protocol = _loc7_[_loc8_];
