package org.osmf.net
{
   ...
   public class NetStreamUtils
   {
      ...
      {
         var _loc4_:FMSURL = null;
         var _loc3_:String = "";
         if(param1 != null)
         {
            if(isRTMPStream(param1))
            {
               _loc4_ = new FMSURL(param1,param2);
               _loc3_ = _loc4_.streamName;
               if(_loc4_.query != null && _loc4_.query != "")
               {
                  _loc3_ = _loc3_ + ("?" + _loc4_.query);
               }
            }
            else
            {
      ...
      {
         var _loc2_:String = StreamType.RECORDED;
      ...
      {
         var _loc4_:StreamingURLResource = null;
         ...
         {
            _loc4_ = param1 as StreamingURLResource;
            if(_loc4_ != null && isStreamingResource(_loc4_))
            {
