package org.osmf.net.dvr
{
   ...
   public class DVRCastNetConnectionFactory extends NetConnectionFactoryBase
   {
      ...
      private function onCreationComplete(param1:NetConnectionFactoryEvent) : void
      {
         ...
         {
            var _loc3_:DVRCastRecordingInfo = null;
         ...
         var urlIncludesFMSApplicationInstance:Boolean = !!streamingResource?Boolean(streamingResource.urlIncludesFMSApplicationInstance):false;
         streamName = NetStreamUtils.getStreamNameFromURL(urlResource.url,urlIncludesFMSApplicationInstance);
         var responder:Responder = new TestableResponder(onStreamSubscriptionResult,onServerCallError);
