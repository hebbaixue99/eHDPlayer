package org.osmf.layout
{
   ...
   public class LayoutRendererBase extends EventDispatcher
   {
      ...
      public final function addTarget(param1:ILayoutTarget) : ILayoutTarget
      {
         ...
         var _loc5_:MetadataWatcher = null;
         if(param1 == null)
         {
         ...
         {
            _loc5_ = new MetadataWatcher(param1.layoutMetadata,_loc4_,null,this.targetMetadataChangeCallback);
            _loc5_.watch();
            _loc3_.push(_loc5_);
         }
      ...
      {
         var _loc2_:ILayoutTarget = null;
         var _loc4_:MetadataWatcher = null;
         if(param1 == null)
         {
            throw new IllegalOperationError(OSMFStrings.getString(OSMFStrings.NULL_PARAM));
         }
      ...
      {
         var _loc4_:DisplayObject = this.stagedDisplayObjects[param1];
         if(_loc4_ == param2)
         {
