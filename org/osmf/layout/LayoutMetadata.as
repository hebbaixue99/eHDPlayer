package org.osmf.layout
{
   ...
   public class LayoutMetadata extends Metadata
   {
      ...
      {
         return !!this.lazyAttributes?Number(this.lazyAttributes.index):Number(NaN);
      }
      ...
      {
         return !!this.lazyAttributes?Boolean(this.lazyAttributes.snapToPixel):true;
      }
      ...
      {
         return !!this.lazyAttributes?Boolean(this.lazyAttributes.includeInLayout):true;
      }
      ...
      {
         return !!this.lazyAbsolute?Number(this.lazyAbsolute.x):Number(NaN);
      }
      ...
      {
         return !!this.lazyAbsolute?Number(this.lazyAbsolute.y):Number(NaN);
      }
      ...
      {
         return !!this.lazyAbsolute?Number(this.lazyAbsolute.width):Number(NaN);
      }
      ...
      {
         return !!this.lazyAbsolute?Number(this.lazyAbsolute.height):Number(NaN);
      }
      ...
      {
         return !!this.lazyRelative?Number(this.lazyRelative.x):Number(NaN);
      }
      ...
      {
         return !!this.lazyRelative?Number(this.lazyRelative.y):Number(NaN);
      }
      ...
      {
         return !!this.lazyRelative?Number(this.lazyRelative.width):Number(NaN);
      }
      ...
      {
         return !!this.lazyRelative?Number(this.lazyRelative.height):Number(NaN);
      }
      ...
      {
         return !!this.lazyAnchor?Number(this.lazyAnchor.left):Number(NaN);
      }
      ...
      {
         return !!this.lazyAnchor?Number(this.lazyAnchor.top):Number(NaN);
      }
      ...
      {
         return !!this.lazyAnchor?Number(this.lazyAnchor.right):Number(NaN);
      }
      ...
      {
         return !!this.lazyAnchor?Number(this.lazyAnchor.bottom):Number(NaN);
      }
      ...
      {
         return !!this.lazyPadding?Number(this.lazyPadding.left):Number(NaN);
      }
      ...
      {
         return !!this.lazyPadding?Number(this.lazyPadding.top):Number(NaN);
      }
      ...
      {
         return !!this.lazyPadding?Number(this.lazyPadding.right):Number(NaN);
      }
      ...
      {
         return !!this.lazyPadding?Number(this.lazyPadding.bottom):Number(NaN);
      }
