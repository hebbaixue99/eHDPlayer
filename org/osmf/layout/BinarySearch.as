package org.osmf.layout
{
   ...
   class BinarySearch
   {
      ...
      public static function search(param1:Object, param2:Function, param3:*, param4:int = 0, param5:int = -2.147483648E9) : int
      {
         var _loc7_:int = 0;
         ...
         param5 = param5 == int.MIN_VALUE?int(param1.length - 1):int(param5);
