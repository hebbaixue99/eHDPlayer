package org.osmf.layout
{
   ...
   public class MediaElementLayoutTarget extends EventDispatcher implements ILayoutTarget
   {
      ...
      public static function getInstance(param1:MediaElement) : MediaElementLayoutTarget
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new MediaElementLayoutTarget(param1,ConstructorLock_256);
      ...
      {
         return !!this.displayObjectTrait?Number(this.displayObjectTrait.mediaWidth):Number(NaN);
      }
      
      public function get measuredHeight() : Number
      {
         return !!this.displayObjectTrait?Number(this.displayObjectTrait.mediaHeight):Number(NaN);
      }
      ...
      private function onMediaElementTraitsChange(param1:MediaElementEvent = null) : void
      {
         ...
         {
            _loc2_ = param1 && param1.type == MediaElementEvent.TRAIT_REMOVE?null:this._mediaElement.getTrait(MediaTraitType.DISPLAY_OBJECT) as DisplayObjectTrait;
      ...
      private function updateDisplayObject(param1:DisplayObject) : void
      {
         ...
         if(param1 is ILayoutTarget && this.renderers.parentRenderer)
         {
...
class ConstructorLock_256
{
    
   
   function ConstructorLock_256()
   {
      super();
   }
}
