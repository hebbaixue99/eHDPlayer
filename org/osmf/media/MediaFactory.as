package org.osmf.media
{
   ...
   public class MediaFactory extends EventDispatcher
   {
      ...
      private static function getIndexOfItem(param1:String, param2:Vector.<MediaFactoryItem>) : int
      {
         ...
         {
            _loc4_ = param2[_loc3_] as MediaFactoryItem;
            if(_loc4_.id == param1)
            {
               return _loc3_;
            }
      ...
      public function get numItems() : int
      {
         ...
         var _loc3_:Vector.<MediaFactoryItem> = null;
         var _loc1_:int = 0;
      ...
      protected function resolveItems(param1:MediaResourceBase, param2:Vector.<MediaFactoryItem>) : MediaFactoryItem
      {
         ...
         {
            _loc5_ = param2[_loc4_] as MediaFactoryItem;
            if(_loc5_.id.indexOf("org.osmf") == -1)
            {
               return _loc5_;
            }
            if(_loc3_ == null)
      ...
      {
         var _loc6_:MediaFactoryItem = null;
         var _loc7_:MediaElement = null;
         var _loc8_:int = 0;
         var _loc9_:MediaFactoryItem = null;
         var _loc10_:ProxyElement = null;
         var _loc4_:MediaElement = null;
         var _loc5_:Vector.<MediaFactoryItem> = getItemsByResource(param1,this.allItems[param2]);
         if(param2 == MediaFactoryItemType.STANDARD)
         {
            _loc6_ = this.resolveItems(param1,_loc5_) as MediaFactoryItem;
            if(_loc6_ != null)
            {
         ...
         else if(param2 == MediaFactoryItemType.PROXY)
         {
            ...
            while(_loc8_ > 0)
            {
               ...
               _loc10_ = this.invokeMediaElementCreationFunction(_loc9_) as ProxyElement;
               if(_loc10_ != null)
               {
