   ...
   public class MediaTypeUtil
   {
      ...
      public static function checkMetadataMatch(param1:String, param2:String, param3:Vector.<String>, param4:Vector.<String>) : int
      {
         if(param1 != null)
         {
            if(param2 != null)
            {
               return matchType(param1,param3) && matchType(param2,param4)?int(METADATA_MATCH_FOUND):int(METADATA_CONFLICTS_FOUND);
            }
            return !!matchType(param1,param3)?int(METADATA_MATCH_FOUND):int(METADATA_CONFLICTS_FOUND);
         }
         if(param2 != null)
         {
            return !!matchType(param2,param4)?int(METADATA_MATCH_FOUND):int(METADATA_CONFLICTS_FOUND);
         }
