package com.hurlant.crypto.symmetric
{
   ...
   public class AESKey implements ISymmetricKey
   {
      ...
      private function expandKey() : void
      {
         ...
         {
            _loc1_ = key[4 * _loc6_ - 4];
            _loc2_ = key[4 * _loc6_ - 3];
            _loc3_ = key[4 * _loc6_ - 2];
            _loc4_ = key[4 * _loc6_ - 1];
            if(!(_loc6_ % _loc7_))
            {
               _loc5_ = _loc4_;
               _loc4_ = Sbox[_loc1_];
            ...
            key[4 * _loc6_ + 0] = key[4 * _loc6_ - 4 * _loc7_ + 0] ^ _loc1_;
            key[4 * _loc6_ + 1] = key[4 * _loc6_ - 4 * _loc7_ + 1] ^ _loc2_;
            key[4 * _loc6_ + 2] = key[4 * _loc6_ - 4 * _loc7_ + 2] ^ _loc3_;
            key[4 * _loc6_ + 3] = key[4 * _loc6_ - 4 * _loc7_ + 3] ^ _loc4_;
            _loc6_++;
         }
      }
